...
public class SettingsPanelStudent extends AppCompatActivity {
    ...
    Button resetEmail, resetPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetEmail = findViewById(R.id.resetEmail_settingsPanel);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        user.updatePassword(newPassword).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(SettingsPanelStudent.this, "Change password correct!", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(SettingsPanelStudent.this, "Change password failure!", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
